      ...
      <div className="contact-box">
        ...
        <div className="container ">
          <div className="row justify-content-start">
            <Card
              imageSrc={' ../React-Portfolio/dist/assets/sql-tracker.png'}
              title={'SQL Epmloyee Tracker'}
              description={'MySQL Node'}
              link={'https://github.com/judy-her/sql-employee-tracker'}
            />
            <Card
              imageSrc={' ../React-Portfolio/dist/assets/beat-by-beat2.0.png'}
            ...
            <Card
              imageSrc={' ../React-Portfolio/dist/assets/Regex-gist.png'}
              title={'Regex Gist'}
            ...
            <Card
              imageSrc={
                ' ../React-Portfolio/dist/assets/e-commerce-backend.png'
              }
